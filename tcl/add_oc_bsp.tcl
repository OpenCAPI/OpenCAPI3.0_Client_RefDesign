...
set verilog_elastic [list \
 ...
 "[file normalize "$card_src/xilinx/elastic_buffer/DLx_phy_example_gtwiz_userclk_tx.v"]"\
 "[file normalize "$card_src/xilinx/elastic_buffer/DLx_phy_example_init.v"]"\
 "[file normalize "$card_src/xilinx/elastic_buffer/DLx_phy_example_reset_sync.v"]"\
 "[file normalize "$card_src/xilinx/elastic_buffer/DLx_phy_example_wrapper_functions.v"]"\
 "[file normalize "$card_src/xilinx/elastic_buffer/DLx_phy_example_wrapper.v"]"\
 "[file normalize "$card_src/xilinx/elastic_buffer/dlx_phy_wrap.v"]"\
]
