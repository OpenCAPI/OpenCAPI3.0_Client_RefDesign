...
//
// Title    : lpc_device.v
// Function : This file is the top level wrapper for the LPC AFU, when used in simulation. It is embedded into 
//            a chip or FPGA wrapper when implemented in hardware.
//
// -------------------------------------------------------------------
// Modification History :
//                               |Version    |     |Author   |Description of change
//                               |-----------|     |-------- |---------------------
  `define LPC_DEVICE_VERSION      16_Jan_2018   //
// -------------------------------------------------------------------
...
// @@@  Module Declaration
// ==============================================================================================================================
// This design only uses one TLX stack, so signals used the abbreviation 'tlx_'. This helps reduce churn in the single AFU 
// simulation test benches, since 'tlx' was used as the design evolved. In designs using multiple TLX stacks, it is
// suggested to use 'tlx0_', 'tlx1_', ... abbreviations. The same is true for designs with multiple AFUs ('afu0_', 'afu1_', ...)
...
cfg_func0 CFG_F0  (               
  ...
  , .cfg_ro_dsn_serial_number            ( 64'hDEAD_DEAD_DEAD_DEAD              ) 
    // OpenCAPI TL - port 0
  , .cfg_ro_otl0_tl_major_vers_capbl     (  8'h03                               )
  , .cfg_ro_otl0_tl_minor_vers_capbl     (  8'h00                               )
