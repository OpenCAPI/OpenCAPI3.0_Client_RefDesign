...
//                                               |-----------|     |-------- |---------------------
  `define LPC_TLX_AFU_CREDIT_MGR_VERSION         12_Oct_2017    //
// -------------------------------------------------------------------
...
assign onevec  = {zerovec, 1'b1};    // Create to avoid Portals width warning

// Note: Avoid Portals warnings by making signals the same width. Portals is an IBM compiler for an internal simulator.
