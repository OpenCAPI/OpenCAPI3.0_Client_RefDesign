...
//
// Title    : lpc_func.v
// Function : This file is the function level wrapper for the LPC AFU.  
//
// -------------------------------------------------------------------
// Modification History :
//                               |Version    |     |Author   |Description of change
//                               |-----------|     |-------- |---------------------
  `define LPC_FUNC_VERSION        21_Nov_2017   //
// -------------------------------------------------------------------

`define TL_VERSION_MAJOR   8'h03  // Update to match OpenCAPI TL spec version (MAJOR.MINOR)
`define TL_VERSION_MINOR   8'h00
