...
set flash_ip_dir      $ip_dir/flash_ip_project/flash_ip_project.srcs/sources_1/ip
set log_dir       $::env(LOGS_DIR)
set log_file      $log_dir/create_flash_ip.log
################################################################
# START
################################################################

## Create a new Vivado IP Project
puts "\[CREATE_FLASH_IP.....\] start [clock format [clock seconds] -format {%T %a %b %d %Y}]"
create_project flash_ip_project $ip_dir/flash_ip_project -force -part $fpga_part -ip >> $log_file
...
#Create block design
create_bd_design $design_name >> $log_file
...
if {[string equal [get_filesets -quiet sources_1] ""]} {
  ...
  set pl_clk0_0 [ create_bd_port -dir O -type clk pl_clk0_0 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {175000000} \
 ] $pl_clk0_0
  set saxihpc0_fpd_aclk_0 [ create_bd_port -dir I -type clk saxihpc0_fpd_aclk_0 ]
  ...
  set lmb_bram_if_cntlr_0_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 lmb_bram_if_cntlr_0_bram ]
  set_property -dict [ list \
  ...
  # Create instance: rst_saxihpc0_fpd_aclk_0_100M, and set properties
  set rst_saxihpc0_fpd_aclk_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_saxihpc0_fpd_aclk_0_100M ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash########################################################################} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {175.000000} \
  ...
  connect_bd_intf_net -intf_net S_AXI_0_1 [get_bd_intf_ports S_AXI_0] [get_bd_intf_pins axi_register_slice_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_LPD]

  # Create port connections
  connect_bd_net -net Reset_0_1 [get_bd_ports Reset_0] [get_bd_pins microblaze_0/Reset]
  connect_bd_net -net aresetn_1 [get_bd_ports aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins rst_saxihpc0_fpd_aclk_0_100M/ext_reset_in]
  connect_bd_net -net mdm_0_Debug_SYS_Rst [get_bd_pins mdm_0/Debug_SYS_Rst] [get_bd_pins rst_saxihpc0_fpd_aclk_0_100M/mb_debug_sys_rst]
  connect_bd_net -net rst_saxihpc0_fpd_aclk_0_100M_bus_struct_reset [get_bd_pins lmb_bram_if_cntlr_0/LMB_Rst] [get_bd_pins rst_saxihpc0_fpd_aclk_0_100M/bus_struct_reset]
  connect_bd_net -net saxihpc0_fpd_aclk_0_1 [get_bd_ports saxihpc0_fpd_aclk_0] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins lmb_bram_if_cntlr_0/LMB_Clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins rst_saxihpc0_fpd_aclk_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxi_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports pl_clk0_0] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x00008000 -offset 0x00000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs lmb_bram_if_cntlr_0/SLMB/Mem] SEG_lmb_bram_if_cntlr_0_Mem
  create_bd_addr_seg -range 0x00008000 -offset 0x00000000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs lmb_bram_if_cntlr_0/SLMB1/Mem] SEG_lmb_bram_if_cntlr_0_Mem
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] SEG_zynq_ultra_ps_e_0_HP0_QSPI
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces S_AXI_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_DDR_LOW] SEG_zynq_ultra_ps_e_0_LPD_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces S_AXI_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_LPS_OCM] SEG_zynq_ultra_ps_e_0_LPD_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces S_AXI_0] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP6/LPD_QSPI] SEG_zynq_ultra_ps_e_0_LPD_QSPI
...
#====================
# Generate the Output products of the Flash block design.
...
puts "                        generating Flash output products"
set_property synth_checkpoint_mode None [get_files  $ip_dir/flash_ip_project/flash_ip_project.srcs/sources_1/bd/design_1/design_1.bd] >> $log_file
#comment following line if you want to debug this file
generate_target all                     [get_files  $ip_dir/flash_ip_project/flash_ip_project.srcs/sources_1/bd/design_1/design_1.bd] >> $log_file

make_wrapper -files [get_files $ip_dir/flash_ip_project/flash_ip_project.srcs/sources_1/bd/design_1/design_1.bd] -top
