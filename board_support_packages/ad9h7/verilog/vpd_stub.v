`timescale 1ps / 1ps
// -------------------------------------------------------------------
// CONFIDENTIAL_STATEMENT=IBM Confidential
// COPYRIGHT_STATEMENT=Copyright 2016-2018 IBM
//
// Title    : vpd_stub.v
...
//                                |-----------|     |-------- |---------------------
//`define vpd_stub_VERSION         14_Mar_2017   //  rueding   Initial creation
//`define vpd_stub_VERSION         26_Apr_2017   //  rueding   Update to match restructured CFG logic
  `define vpd_stub_VERSION         12_Sep_2017   //  rueding   Change items reported by HAL check
// -------------------------------------------------------------------
