...
#set_false_path -from [get_clocks dbg_hub/inst/BSCANID.u_xsdbm_id/SWITCH_N_EXT_BSCAN.bscan_inst/SERIES7_BSCAN.bscan_inst/INTERNAL_TCK] -to [get_clocks txoutclk_out[0]_1]
set_false_path -from [get_clocks oc0_clock_afu] -to [get_clocks txoutclk_out[0]_1]
set_false_path -from [get_clocks refclk_bufg_apb_clk_BUFGCE_O_0] -to [get_clocks oc0_clock_afu]
set_false_path -from [get_clocks refclk_bufg_apb_clk_BUFGCE_O_0] -to [get_clocks txoutclk_out[0]_1]
set_false_path -from [get_clocks oc0_clock_afu] -to [get_clocks refclk_bufg_apb_clk_BUFGCE_O_0]
set_false_path -from [get_clocks txoutclk_out[0]_1] -to [get_clocks refclk_bufg_apb_clk_BUFGCE_O_0]
...
#add_cells_to_pblock pblock_2 [get_cells [list oc_func0/fw_afu/hbm_top_wrapper_i]]

#remove_cells_from_pblock pblock_2 [get_cells oc_func?/fw_afu/hbm_top_wrapper_i/hbm_top_i/hbm]

create_pblock pblock_3
resize_pblock pblock_3 -add CLOCKREGION_X0Y0:CLOCKREGION_X7Y3
add_cells_to_pblock pblock_3 [get_cells [list oc_func?/fw_afu/hbm_top_wrapper_i/hbm_top_i/hbm]]

#set_false_path -to [get_cells -hierarchical -filter {NAME =~ dbg_hub/inst/BSCANID.u_xsdbm_id/CORE_XSDB.UUT_MASTER/U_XSDB_ADDRESS_CONTROLLER/addr_reg*}]
#set_false_path -to [get_pins { dbg_hub/inst/BSCANID.u_xsdbm_id/CORE_XSDB.UUT_MASTER/U_XSDB_ADDRESS_CONTROLLER/addr_reg[*]/C }]
set_false_path -from [get_pins { dbg_hub/inst/BSCANID.u_xsdbm_id/CORE_XSDB.UUT_MASTER/U_XSDB_ADDRESS_CONTROLLER/addr_reg[*]/C }]
set_false_path -to [get_pins {oc_func0/fw_afu/hbm_top_wrapper_i/hbm_top_i/hbm/inst/TWO_STACK.u_hbm_top/TWO_STACK_HBM.u_xsdb_top_0/U_XSDB_SLAVE/reg_test_reg[*]/CE}]
